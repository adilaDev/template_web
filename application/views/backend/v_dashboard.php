        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="h3 text-center">Template untuk Backend atau Admin Web</div>
                            <p class="text-muted">
                                jika ingin melihat banyak fitur silahkan klik menu pada navbar di atas. atau bisa langsung lihat di template <a href="<?= base_url() ?>template/Ajax/" target="_blank" class="text-danger">berikut</a>
                                <br>
                                Dan jika anda ingin lihat template <strong>Frontend</strong> atau <strong>Landing Page</strong> klik <a href="<?= base_url('frontend') ?>" class="text-danger">disini</a>
                            </p>
                        </div>
                    </div>
                </div>
