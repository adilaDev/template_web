...
(function(factory) {
    ...
    $.fn.SumoSelect = function(options) {
        ...
        const defaultOptions = {
            placeholder: 'ここで選択', // Dont change it here.
            csvDispCount: 3, // display no. of items in multiselect. 0 to display all.
            captionFormat: '{0} 選択済み', // format of caption text. you can set your locale.
            captionFormatAllSelected: '{0} すべて選択！', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
            ...
            searchText: '探す...', // placeholder for search input
            searchFn(haystack, needle) { // search function
                return haystack.toLowerCase().indexOf(needle.toLowerCase()) < 0;
            },
            noMatch: 'に一致するものはありません "{0}"',
            prefix: '', // some prefix usually the field name. eg. '<b>Hello</b>'
            locale: ['わかった', 'キャンセル', 'すべて選択', 'すべてクリア'], // all text that is used. don't change the index.
